...
한글은 `font family`에서 **Noto Sans KR**을 고르고 `font style`에서 **Bold**를 먼저 시험하세요. 2026-09-15 MakerWorld에서 Noto Sans KR, Noto Serif KR, NanumGothic, Black Han Sans, Gothic A1, Gowun Batang, Gowun Dodum, Hahmlet, IBM Plex Sans KR, Dongle, Gamja Flower, Hi Melody, Moirai One, Nanum Brush Script가 정상 적용됨을 확인했습니다. 맑은 고딕과 Liberation Sans는 MakerWorld에서 한글이 네모로 표시돼 선택지에서 제거했습니다. 서버에 설치되지 않은 TTF 파일은 이 단일 SCAD에 직접 첨부할 수 없습니다.
